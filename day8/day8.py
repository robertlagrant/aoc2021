...
print(f"Part 1: {sum(parse_line(l, lambda _, outs: sum(str(len(o)) in '2347' for o in outs)) for l in lines)}")
print(f"Part 2: {sum(parse_line(l, lambda defs, outs: int(''.join(str(defs[o]) for o in outs)) ) for l in lines)}")
